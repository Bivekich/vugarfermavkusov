          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                <li><Link to="/" className="text-gray-600 hover:text-brand">Главная</Link></li>
                <li><Link to="/aboutus" className="text-gray-600 hover:text-brand">О нас</Link></li>
                <li><Link to="/faq" className="text-gray-600 hover:text-brand">FAQ</Link></li>
                <li><Link to="https://biveki.ru" className="text-gray-600 hover:text-brand">Разработка сайтов</Link></li>
              </ul>
            </div>
            <div className="space-y-4">
              ...
              <p className="text-gray-600">Телефон: 89158181861</p>
            </div>
            <div className="space-y-4">
